...
-- CreateIndex
CREATE UNIQUE INDEX "RestaurantOwner_restaurantOwnerId_key" ON "RestaurantOwner" ("restaurantOwnerId");
...
ALTER TABLE "RestaurantOwner"
    ADD CONSTRAINT "RestaurantOwner_restaurantOwnerId_fkey" FOREIGN KEY ("restaurantOwnerId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
